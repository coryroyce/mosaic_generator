...
def test_01():
    # path_to_check = "src/mosaic_generator/input_images/Pikachu.jpeg"
    ...
    # Source Image
    source_image = "src/mosaic_generator/input_images/Pikachu.jpeg"
    tile_dir = "src/mosaic_generator/source_images"
